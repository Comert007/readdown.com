---
title: Android上的FFmpeg命令行
date: 2019-12-22 16:36:17
categories:
  - "ffmpeg"
tags: ["ffmpeg","command"]
thumbnail: /img/ffmpeg/ffmpeg-command-show1.jpg
---

> 在我们的开发中，经常会用到音视频相关内容，一般我们都会选择`FFmpeg`，但是其交叉编译对于我们来说是一件很麻烦的事情．所以这里方便日后使用，集成了关于`FFmpeg`相关库(mp3lame+libx264+fdk-aac)[FFmpegCommand](https://github.com/AnJoiner/FFmpegCommand),话不多说，请往下看～～
...
<figure class="third">
    <img src="/img/ffmpeg/ffmpeg-command-show1.jpg">
...
### [--------------Demo APK 下载地址---------------](https://fir.im/nfyz)
